...
class RestaurantRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'customers' => ['required', 'integer','min:1', 'max:1000'],
            'employees' => ['required', 'integer','min:1', 'max:1000'],
    ...
    public function messages()
    {
        return [
            ...
            'customers.max' => 'Please enter no more than 1000 characters for restaurant customers',
            'employees.max' => 'Please enter at least 1 character for restaurant employees',
            'employees.max' => 'Please enter no more than 1000 characters for restaurant employees'
